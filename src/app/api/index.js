...
const apis = {
  ...
  //  getAllDoctor: () => {
  //   return API.get(API_ENDPOINTS.GET_ALL_HOSPITAL);
  //  },
  ...
  //   deleteChannelStream: channel_id => {
  ...
  //     return API.delete(API_ENDPOINTS.DELETE_MOD_MEDIA + '/' + mod_id);
  //   },
  ...
  //   deleteVodCategory: categoryid => {
  //     return API.delete(
  //       API_ENDPOINTS.DELETE_VOD_CATEGORY + '?categoryid=' + categoryid,
  //     );
  //   },
  ...
  //   deleteEPG: channels => {
  //     return API.delete(API_ENDPOINTS.DELETE_EPG + '/' + channels);
  //   },
