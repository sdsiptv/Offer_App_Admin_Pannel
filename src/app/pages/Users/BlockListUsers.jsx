...
export default function ListBlocklistUsers() {
    ...
    const handleBlockusers = (rowData) => {
        apis.addUserUnBlock(rowData.id).then(res => {
          toastMessage('User UnBlock successfully');
          getBlockUsers();
        }).catch(error => {
        ...
        <Container component="main" maxWidth="xl">
            ...
            <div className={classes.paper}>
                <Grid container spacing={1}>
                    <Grid item xs={12}>
                        <DRMWaitListTable
                            title={<span style={{ color: '#ff3737', fontSize: "x-large" }}>ALL BLOCK USERS LIST</span>}
                            columns={columns}
                            data={Users}
                        />
                    </Grid>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog}>
                <DialogTitle style={{ fontSize: "20px", color: "#E74C3C",textAlign:"center" }}>BLOCK USERS DETAILS</DialogTitle>
                <DialogContent>
                    {selectedVendor && (
                        <TableContainer>
                            <Table>
